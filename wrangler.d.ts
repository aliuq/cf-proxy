 ...
 */
declare type ConfigModuleRuleType =
  | "ESModule"
  | "CommonJS"
  | "CompiledWasm"
  | "Text"
...
declare interface LocalDevelopmentSettings {
  /**
  ...
  port?: number;
  /**
   * Protocol that local dev server listens to requests on
   * 
   * @default `http`
   */
  local_protocol?: string;
  /**
   * Protocol that the local dev server forwards requests on
   * 
   * @default `https`
   */
...
declare interface WranglerConfig extends Partial<Environment> {
